...
const GptExamModal = ({ show, onHide, size, type, passage, optionList, setPassage, setOptionList }) => {
    ...
    >
      ...
      <Modal.Body style={{ backgroundColor: "#efefef", borderRadius: "5px", display: "flex", flexDirection: "column", gap: "10px" }}>
        ...
        {gptRes === "loading"
          ...
          : <MainBtn onClick={handleAiOnClick}>AI 리터칭</MainBtn>}
      </Modal.Body>
